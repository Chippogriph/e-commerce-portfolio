...
db.exec(`
INSERT OR IGNORE INTO categories (name, imageUrl, slug) VALUES
('Formal', '/images/categories/formal.jpg', 'formal'),
('Casual', '/images/categories/casual.jpg', 'casual'),
('Barn', '/images/categories/children.jpg', 'barn');
`);

// Lägg till produkter
db.exec(`
INSERT OR IGNORE INTO products (slug, name, description, imageUrl, brand, sku, price, quantity, publishedDate, categoryId) VALUES
...
console.log("Databas och tabeller skapade samt testdata insatt!");
